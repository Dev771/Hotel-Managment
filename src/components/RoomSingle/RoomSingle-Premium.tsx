        ...
        <>
            ...
            <section className="room-single">
                ...
                <div className="upper-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                    ...
                    <h2>Premium Suit Room</h2>
                    <div className="pricing clearfix">
                        <div className="price">
                        Start From: <span>₹7000.00</span> / Per Night
                        </div>
                    ...
                    <div className="text">
                        ...
                        <p>
                        The fireplace is the standout feature of this suite. The air-conditioned suite has 1 bedroom and 1 bathroom with a walk-in shower and a bath. Boasting a terrace with city views, this suite also features soundproof walls and a flat-screen TV with cable channels. The unit has 1 bed.
                        </p>
                    </div>
                    </div>
                </div>
